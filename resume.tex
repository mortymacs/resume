...
% -- title
\par {\centering {\Huge Morteza \textsc{Nourelahi Alamdari}\\}\bigskip \emph{Senior Software Engineer} \par}
...
\begin{tabular}{lr}
    ...
    \textsc{C/C++, Go, Python, Cython}\\
    \textsc{GNU/Linux Software Development, Test-Driven, Design Pattern, Refactoring}\\
...
\begin{tabular}{r|p{11cm}}
    ...
    \multirow{3}{*}{Author}
    & \textbf{fawnbee} - parallel and concurrent C/C++ library\\
    & \textbf{hotconf} - Flexible config parser for C/C++ \& Python\\
    & \textbf{pyibsng} - IBSng Python driver\\

    \multirow{4}{*}{Individual Contributer}
    & \textbf{libzmq} - ZeroMQ core engine in C++, implements ZMTP/3.1\\
    & \textbf{zmqpp} - 0mq 'highlevel' C++ bindings\\
