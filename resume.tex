...
\setmainfont[
    SmallCapsFont = IBMPlexSansCondensed-Regular.ttf,
    BoldFont = IBMPlexSansCondensed-Bold.ttf,
    ItalicFont = IBMPlexSansCondensed-Italic.ttf
]
...
\begin{tabular}{lr}
    ...
    \textbf{Programming Languages:} \textsc{Python, C/C++, Go}\\
    ...
    \textbf{Libraries/Frameworks:} \textsc{Django, Tornado, Flask, Boost, APR, RoutingKit, GTK}\\
    \textbf{Debugging:} \textsc{PDB, GDB, Valgrind, Perf, Massif-Visualizer, KCacheGrind, HeapTrack, HotSpot}\\
    \textbf{Tests:} \textsc{Pytest, Catch2}\\
    ...
    \textbf{DevOps:} \textsc{Bash, Kubernetes, Docker, SaltStack}\\
...
\begin{tabular}{r|p{11cm}}
    ...
    & \textbf{gcalcli} - Google Calendar Command Line Interface\\
...
\begin{tabular}{r|p{11cm}}
    ...
    Delft, Netherlands\\
    &\footnotesize{Technologies: Python, C++, Linux, Kafka, ZMQ, Docker, Kubernetes, PostgreSQL, Redis, Django, SaltStack, Jenkins, GCP}\\
...
\begin{tabular}{r|p{11cm}}
    ...
    Tehran, Iran\\
    &\footnotesize{Instructor of Python and Django, C++ (Core), Web Design Fundamentals, jQuery, javascript, XML}\\

    \multicolumn{2}{c}{}\\
    \textsc{Apr 2013 - May 2014}
    & Backend Developer at \textsc{Hami System Sharif},
    Tehran, Iran\\
    &\footnotesize{Technologies: Python, PHP, Ruby, Linux, SOAP, WSDL, REST, MySQL, Django}\\
